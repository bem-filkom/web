    ...
    <Box>
      ...
      >
        ...
        <Box basis="1/2" justify="center" pad={{"horizontal":"large"}}>
          <Heading size="45px " level="2" textAlign="center">
            VISI-MISI BEM FILKOM UB <br/> Elaborasi Makna
          </Heading>
        </Box>
        <Box className="relatify" responsive="true" width="small" alignContent="center" justify="center" align="center"></Box>
      </Box>
      ...
      >
        <Box basis="1/5" justify="center" align="center" pad={{vertical:"large", horizontal:"xlarge"}}>
